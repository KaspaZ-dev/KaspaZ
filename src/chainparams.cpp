...
public:
    CMainParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("kaspazseeds.org", "kmd.kaspazseeds.org")); // decker
        ...
        /*
        vSeeds.push_back(CDNSSeedData("kaspazseeds.com", "kmd.kaspazseeds.com"));
        vSeeds.push_back(CDNSSeedData("kaspazseeds.com", "dynamic.kaspazseeds.com"));
        */
...
void kaspaz_setactivation(int32_t height)
{
...
const CChainParams::CCheckpointData GetACCheckPoints()
{
    /* 1. The checkpoints utilized in this translation unit can be accessed using the get-checkpoints.py
      script from the kaspaz_scripts repository - https://github.com/DeckerSU/kaspaz_scripts .
