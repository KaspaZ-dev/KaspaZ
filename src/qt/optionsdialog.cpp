    ...
    mapper(0)
{
    ...
    ui->kaspazAtStartup->setToolTip(ui->kaspazAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kaspazAtStartup->setText(ui->kaspazAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->kaspazAtStartup, OptionsModel::StartAtStartup);
