...
namespace GMPArithTests
{
    ...
    /*
        ...
        in a few areas, such as bitcoin_address (found in kaspaz_utils.cpp) or NSPV-related functions in
        kaspaz_nSPV_superlite.h or kaspaz_nSPV_wallet.h. However, our codebase already has other methods to compute
