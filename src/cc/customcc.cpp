/*
 ...
 Just update the functions in this file, then from ~/kaspaz/src/cc
 
 ../kaspaz-cli -ac_name=CUSTOM stop
 ./makecustom
 ../kaspazd -ac_name=CUSTOM -ac_cclib=custom -ac_cc=2 ...
 
 The above will rebuild kaspazd and get it running again
 */
...
{
    CMutableTransaction mtx = CreateNewContextualCMutableTransaction(Params().GetConsensus(), kaspaz_nextheight()); std::string rawtx;
