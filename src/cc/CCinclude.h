...
///
/// One other technical note is that kaspazd has the insight-explorer extensions built in 
...
/// https://developers.kaspazplatform.com/basic-docs/start-here/about-kaspaz-platform/product-introductions.html#smart-chains-antara
...
/// Returns my pubkey, that is set by -pubkey kaspazd parameter
...
/// By using -addressindex=1 of kaspazd daemon, it allows tracking of all the CC addresses.
///
...
/// 'My pubkey' is the -pubkey parameter of kaspazd.
/// @param mtx mutable transaction object
/// @param total amount of inputs to add. If total equals to 0 the function does not add inputs but returns amount of all available normal inputs in the wallet
/// @param maxinputs maximum number of inputs to add
...
/// Logging category is set by -debug=category kaspazd param.
