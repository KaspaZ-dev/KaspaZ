...
# Input
DEPENDPATH += .
HEADERS += src\kaspaz_globals.h \
     src\qt\kaspazoceangui.h \
     ...
     src\qt\kaspazaddressvalidator.h \
     ...
     src\streams.h \
     src\kaspaz_bitcoind.h \
     src\kaspaz_utils.h \
     src\kaspaz_notary.h \
     src\kaspaz_gateway.h
...
SOURCES += src\protobuf\google\protobuf\any.cc \
    ...
    src\qt\intro.cpp \
    src\qt\kaspaz.cpp \
    src\qt\kaspazaddressvalidator.cpp \
    src\qt\kaspazamountfield.cpp \
    src\qt\kaspazoceangui.cpp \
    src\qt\kaspazunits.cpp \
...
# also add new translations to kaspaz.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/kaspaz_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md src/qt/res/kaspaz-qt-res.rc
...
windows:RC_FILE = src/qt/res/kaspaz-qt-res.rc
...
macx:ICON = src/qt/res/icons/kaspaz.icns
