...
copy_release() {
    ...
    case $release_name in
        xenial)
            ...
            mv "${WORKSPACE}/releases/${release_name}/kaspaz-qt" "${WORKSPACE}/releases/${release_name}/kaspaz-qt-linux"
            ;;
        focal)
        ...
        windows)
            ...
            mv "${WORKSPACE}/releases/${release_name}/kaspaz-qt${ext}" "${WORKSPACE}/releases/${release_name}/kaspaz-qt-windows${ext}"
            ;;
        macos)
            ...
            mv "${WORKSPACE}/releases/${release_name}/kaspaz-qt${ext}" "${WORKSPACE}/releases/${release_name}/kaspaz-qt-mac${ext}"
            ;;
        *)
